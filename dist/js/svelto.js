...
;(function ($, _, window, document, undefined) {
    ...
    $.Widget.prototype = {
        ...
        _createWidget: function _createWidget(options, element) {
            ...
            this.initializationType = element ? 'element' : this.defaultElement ? 'html' : this.templates.base ? 'template' : 'none';
        ...
        _on: function _on(suppressDisabledCheck, $element, events, selector, handler) {
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.autogrow', {
        ...
        _update_input_width: function _update_input_width() {
        ...
        _get_input_needed_width: function _get_input_needed_width() {
        ...
        _update_textarea_height: function _update_textarea_height() {
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.colorpicker', {
        ...
        _update_variables: function _update_variables() {
        ...
        _handler_resize: function _handler_resize() {
        ...
        _handler_sb_wrp_arrows_in: function _handler_sb_wrp_arrows_in() {

            this._on($document, 'keydown', this._handler_sb_wrp_arrows_keydown);
        },

        _handler_sb_wrp_arrows_out: function _handler_sb_wrp_arrows_out() {

            this._off($document, 'keydown', this._handler_sb_wrp_arrows_keydown);
        },

        _handler_sb_wrp_arrows_keydown: function _handler_sb_wrp_arrows_keydown() {
        ...
        _sb_drag_set: function _sb_drag_set(XY, update) {
        ...
        _handler_sb_drag_move: function _handler_sb_drag_move(event, data) {

            this._sb_drag_set(data.moveXY, this.options.live);
        },

        _handler_sb_drag_end: function _handler_sb_drag_end(event, data) {
        ...
        _handler_hue_wrp_arrows_in: function _handler_hue_wrp_arrows_in() {

            this._on($document, 'keydown', this._handler_hue_wrp_arrows_keydown);
        },

        _handler_hue_wrp_arrows_out: function _handler_hue_wrp_arrows_out() {

            this._off($document, 'keydown', this._handler_hue_wrp_arrows_keydown);
        },

        _handler_hue_wrp_arrows_keydown: function _handler_hue_wrp_arrows_keydown() {
        ...
        _hue_drag_set: function _hue_drag_set(XY, update) {
        ...
        _handler_hue_drag_move: function _handler_hue_drag_move(event, data) {

            this._hue_drag_set(data.moveXY, this.options.live);
        },

        _handler_hue_drag_end: function _handler_hue_drag_end(event, data) {
        ...
        _handler_input_keydown: function _handler_input_keydown(event) {
        ...
        _update_input: function _update_input() {
        ...
        _update_sb: function _update_sb() {
        ...
        _update_hue: function _update_hue() {
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.datepicker', {
        ...
        _handler_arrows_in: function _handler_arrows_in() {

            this._on($document, 'keydown', this._handler_arrows_keydown);
        },

        _handler_arrows_out: function _handler_arrows_out() {

            this._off($document, 'keydown', this._handler_arrows_keydown);
        },

        _handler_arrows_keydown: function _handler_arrows_keydown(event) {
        ...
        _handler_prev_click: function _handler_prev_click() {

            this.navigate_month(-1);
        },

        _handler_next_click: function _handler_next_click() {
        ...
        _handler_day_current_click: function _handler_day_current_click(event, node) {
        ...
        _build_calendar: function _build_calendar() {
        ...
        _highlight_day: function _highlight_day(day, css_class) {
        ...
        _unhighlight_selected: function _unhighlight_selected() {
        ...
        _highlight_selected: function _highlight_selected() {

            this.$day_selected = this._highlight_day(this.options.date.selected, 'datepicker-day-selected');
        },

        _unhighlight_today: function _unhighlight_today() {
        ...
        navigate_month: function navigate_month(steps) {
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.dropdown', {
        ...
        _bind_window_resize_scroll: function _bind_window_resize_scroll() {

            this._on($window, 'resize scroll', this._update);
        },

        _unbind_window_resize_scroll: function _unbind_window_resize_scroll() {
        ...
        _bind_window_click: function _bind_window_click() {

            this._on($window, 'click', this._handler_window_click);
        },

        _unbind_window_click: function _unbind_window_click() {

            this._off($window, 'click', this._handler_window_click);
        },

        _handler_window_click: function _handler_window_click(event) {

            var $parents = $(event.target).parents();

            if ($parents.index(this.$dropdown) === -1) {
                //INFO: Checking if we clicked inside the dropdown or another trigger for this dropdown
        ...
        _positionate: function _positionate() {
            ...
            this.$dropdown.positionate({
                $anchor: $trigger,
                $pointer: function $pointer(data) {
                    if (!no_tip) {
                        return instance['$' + instance._get_opposite_direction(data.direction) + '_tip'];
                    }
                },
                callbacks: {
                    positionated: function positionated(data) {
        ...
        _get_opposite_direction: function _get_opposite_direction(direction) {
...
;(function ($, _, window, document, undefined) {
    ...
    $.fn.loading = function (force, custom_options) {
        ...
        if ($overlay.length === 0) {
            ...
            this.prepend('<div class="spinner-overlay ' + options.color.wrapper + '">' + '<div class="spinner-wrp">' + '<div class="spinner ' + options.color.spinner + '">' + '<div class="circle-wrp left">' + '<div class="circle"></div>' + '</div>' + '<div class="circle-wrp right">' + '<div class="circle"></div>' + '</div>' + '</div>' + '</div>' + '</div>');
        } else {
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.noty', {
        ...
        templates: {
            ...
            '<div class="container-content">' + '<div class="infobar-wrp inset {%=o.color%}">' + //TODO: add back transparentize
            '{% if ( o.img ) include ( "presto.noty.img", o.img ); %}' + '<div class="infobar-center">' + '{% if ( o.title ) include ( "presto.noty.title", o.title ); %}' + '{% if ( o.body ) include ( "presto.noty.body", o.body ); %}' + '</div>' + '{% if ( o.buttons.length === 1 ) include ( "presto.noty.single_button", o.buttons[0] ); %}' + '</div>' + '{% if ( o.buttons.length > 1 ) include ( "presto.noty.buttons", o.buttons ); %}' + '</div>' + '</div>',
            img: '<div class="noty-img infobar-left">' + '<img src="{%=o%}" class="smooth" />' + '</div>',
            title: '<p class="infobar-title">' + '{%#o%}' + '</p>',
            body: '{%#o%}',
            single_button: '<div class="infobar-right">' + '{% include ( "presto.noty.button", o ); %}' + '</div>',
            buttons: '<div class="noty-buttons multiple-wrp centered">' + '<div class="multiple">' + '{% for ( var i = 0; i < o.length; i++ ) { %}' + '{% include ( "presto.noty.button", o[i] ); %}' + '{% } %}' + '</div>' + '</div>',
            button: '<div class="label-wrp button-wrp">' + '<div class="label actionable {%=(o.color || "white")%} {%=(o.size || "small")%} {%=(o.css || "")%}">' + '<div class="label-center">' + '{%#(o.text || "")%}' + '</div>' + '</div>' + '</div>'
        },
        ...
        _init_click: function _init_click() {
        ...
        _init_buttons_click: function _init_buttons_click() {
        ...
        _init_timer: function _init_timer() {
        ...
        _init_hover: function _init_hover() {
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.modal', {
        ...
        _handler_esc_keydown: function _handler_esc_keydown(event) {
    ...
    $(function () {
        ...
        $('[data-modal-trigger]').on('click', function () {
            //TODO: maybe do something like this for the other triggable widgets... so that we don't care if a trigger changes or is added dynamically //TODO: use delegation
...
;(function ($, _, window, document, undefined) {
    ...
    var Container = function Container(name, expiry) {
    ...
    var Action = function Action(container, name, action) {
  ...
  var e = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
      t = self.Prism = { util: { encode: function encode(e) {
        ...
        i = i || t.languages;var s = i[e];if (arguments.length == 2) {
          r = arguments[1];for (var o in r) r.hasOwnProperty(o) && (s[o] = r[o]);return s;
        }var u = {};for (var a in s) if (s.hasOwnProperty(a)) {
          if (a == n) for (var o in r) r.hasOwnProperty(o) && (u[o] = r[o]);u[a] = s[a];
    ...
    }t.hooks.run("wrap", s);var u = "";for (var a in s.attributes) u += a + '="' + (s.attributes[a] || "") + '"';return "<" + s.tag + ' class="' + s.classes.join(" ") + '" ' + u + ">" + s.content + "</" + s.tag + ">";
  };if (!self.document) {
...
;(function ($, _, window, document, undefined) {
    ...
    var generate_options = function generate_options(options, multiple) {
    ...
    $.widget('presto.progressBar', {
        ...
        templates: {
            base: '<div class="progressBar {%=(o.striped ? "striped" : "")%} {%=o.color%} {%=o.size%} {%=o.css%}">' + '<div class="progressBar-unhighlighted">' + '{% include ( "presto.progressBar.percentages" + ( o.labeled ? "_labeled" : "" ), o.percentages ); %}' + '</div>' + '<div class="progressBar-stripes"></div>' + '</div>',
            percentages: '{% for ( var i = 0; i < o.length; i++ ) { %}' + '{% include ( "presto.progressBar.percentage", o[i] ); %}' + '{% } %}',
            percentages_labeled: '{% for ( var i = 0; i < o.length; i++ ) { %}' + '{% include ( "presto.progressBar.percentage_labeled", o[i] ); %}' + '{% } %}',
            percentage: '<div class="progressBar-highlighted {%=(o.color || "")%} {%=(o.css || "")%}"></div>',
            percentage_labeled: '<div class="progressBar-highlighted {%=(o.color || "")%} {%=(o.css || "")%}">' + '{% include ( "presto.progressBar.label", {} ); %}' + '</div>',
        ...
        set: function set(options, multiple) {
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.select', {
        ...
        templates: {
            base: '<div id="dropdown-{%=o.id%}" class="dropdown select-dropdown attached">' + '<div class="container">' + '<div class="container-content">' + '<div class="multiple-wrp vertical stretched joined">' + '<div class="multiple">' + '{% for ( var i = 0, l = o.options.length; i < l; i++ ) { %}' + '{% include ( "presto.select." + ( o.options[i].value ? "option" : "optgroup" ), o.options[i] ); %}' + '{% } %}' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>',
            optgroup: '<div class="divider-wrp block">' + '<div class="divider">' + '{%=o.prop%}' + '</div>' + '</div>',
            option: '<div class="label-wrp button-wrp" data-value="{%=o.prop%}">' + '<div class="label actionable sharp">' + '<div class="label-center">' + '{%=o.value%}' + '</div>' + '</div>' + '</div>'
        },
        ...
        _handler_button_click: function _handler_button_click(event, button) {
        ...
        _init_select_options: function _init_select_options() {
            //FIXME: Add support for arbitrary number of optgroups levels

            var previous_optgroup, current_optgroup;
        ...
        _init_dropdown: function _init_dropdown() {
        ...
        _update_valueholder: function _update_valueholder() {
        ...
        _update_dropdown: function _update_dropdown() {
        ...
        _set_dropdown_width: function _set_dropdown_width() {
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.selectable', {
        ...
        _handler_keys_in: function _handler_keys_in() {

            this._on($document, 'keydown', this._handler_keys_keydown);
        },

        _handler_keys_out: function _handler_keys_out() {

            this._off($document, 'keydown', this._handler_keys_keydown);
        },

        _handler_keys_keydown: function _handler_keys_keydown(event) {

            if ($.browser.isMac && event.metaKey || !$.browser.isMac && event.ctrlKey) {
                //INFO: COMMAND or CTRL, is we are on Mac or not
        ...
        _handler_mousedown: function _handler_mousedown(event) {
        ...
        _handler_mousemove: function _handler_mousemove(event) {
            // DRAG
        ...
        _handler_drag_mouseenter: function _handler_drag_mouseenter(event) {
            // DRAG HOVER
        ...
        _handler_drag_mouseup: function _handler_drag_mouseup() {
            // DRAG END
        ...
        _handler_mouseup: function _handler_mouseup(event) {
            // CLICK
            ...
            } else if ($.browser.isMac && event.metaKey || !$.browser.isMac && event.ctrlKey || $.browser.isMobile) {
        ...
        _handler_clear_selection: function _handler_clear_selection() {
        ...
        _reset_prevs: function _reset_prevs() {
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.slider', {
        ...
        _round_value: function _round_value(value) {

            return Number(Number(value).toFixed(this.options.decimals));
        },

        _update_positions: function _update_positions() {
        ...
        _update_label: function _update_label(value) {
        ...
        modifier_x: function modifier_x(distance) {
            //TODO: maybe we should export this function as a lodash mixin
        ...
        _handler_drag_beforestart: function _handler_drag_beforestart() {
        ...
        _handler_drag_move: function _handler_drag_move(data) {
        ...
        _handler_drag_end: function _handler_drag_end(data) {
        ...
        _handler_click: function _handler_click(event) {
    ...
    $.widget('presto.sortable', {
        ...
        _handler_click: function _handler_click(event) {
            ...
            var new_index = this.$headers.index(event.target),
                new_direction = this.current_index === new_index ? this.current_direction === 'asc' ? 'desc' : 'asc' : 'asc';
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.stepper', {
        ...
        _handler_input_change: function _handler_input_change() {
        ...
        _handler_arrows_in: function _handler_arrows_in(event) {

            this._on($document, 'keydown', this._handler_arrows_keydown);
        },

        _handler_arrows_out: function _handler_arrows_out(event) {
        ...
        navigate: function navigate(modifier) {
...
;(function ($, window, document, undefined) {
    ...
    $.widget('presto.switch', {
        ...
        _handler_click: function _handler_click() {
        ...
        _set_check: function _set_check(checked, force) {
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.tableHelper', {
        ...
        _variables: function _variables() {
            ...
            this.$table = this.$element;
            this.$thead = this.$table.find('thead'), this.$tfoot = this.$table.find('tfoot'), this.$tbody = this.$table.find('tbody'), this.$headers = this.$thead.find('th'), this.$empty_row = this.$tbody.find('tr.empty'), this.columns_nr = this.$headers.length;
        },
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.tagbox', {
        ...
        templates: {
            tag: '<div class="multiple-wrp joined tagbox-tag" data-tag-value="{%=o.str%}">' + '<div class="multiple">' + '<div class="label-wrp">' + '<div class="label compact {%=(o.color ? o.color : "")%} {%=(o.size ? o.size : "")%} {%=(o.css ? o.css : "")%}">' + '<div class="label-center">' + '{%=o.str%}' + '<div class="icon icon-navigation-close right tagbox-tag-remover"></div>' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>'
        },
        ...
        options: {
            ...
            characters: {
                ...
                inserters: [$.ui.keyCode.ENTER, $.ui.keyCode.TAB] },
            //TODO: write them as string, so they are easier to edit and that's the format that the user expects
        ...
        _clear_partial: function _clear_partial() {
        ...
        _partial_add_tag: function _partial_add_tag(tag_str) {
        ...
        _partial_remove_tag: function _partial_remove_tag($tag, tag_str) {
        ...
        _handler_keypress_keydown: function _handler_keypress_keydown(event) {
        ...
        _handler_paste: function _handler_paste(event) {
        ...
        _handler_click_on_tag_remover: function _handler_click_on_tag_remover(event, tag_remover) {
        ...
        _handler_click_on_empty: function _handler_click_on_empty(event) {
        ...
        remove: function remove(tags_str, edit) {
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.tabs', {
        ...
        _hander_button_click: function _hander_button_click(event, node) {
        ...
        _positionate_indicator: function _positionate_indicator() {
        ...
        select: function select(index, force) {
...
;(function ($, _, window, document, undefined) {
    ...
    $.widget('presto.timeAgo', {
        ...
        _update_loop: function _update_loop(wait) {
...
;(function ($, _, window, document, undefined) {
    ...
    var get_coordinates = function get_coordinates($ele) {
    ...
    var get_overlapping_area = function get_overlapping_area(c1, c2) {
