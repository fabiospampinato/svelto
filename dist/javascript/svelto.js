    ...
    _createClass(Widgetize, [{
      ...
      value: function add(selector, widgetizer, data) {
        ...
        if (this._isReady) {
          ...
          var $widgets = this._getWidgets($.$body, selector);
...
(function ($, _, Svelto) {
  ...
  var widget = {
    ...
    get: function get(element, Widget, options) {
      var instanciate = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    ...
    remove: function remove(element, instance) {
      ...
      var name = 'config' in instance ? instance.config.name : instance.name;
...
(function ($, _, Svelto) {
  ...
  var Plugin = {
    call: function call(Widget, options) {

      var isMethodCall = _.isString(options) && options.charAt(0) !== '_'; // Methods starting with '_' are private

      for (var _len3 = arguments.length, args = Array(_len3 > 2 ? _len3 - 2 : 0), _key4 = 2; _key4 < _len3; _key4++) {
        args[_key4 - 2] = arguments[_key4];
      }

      for (var i = 0, l = this.length; i < l; i++) {

        var instance = $.widget.get(this[i], Widget, options, true);
...
(function ($, _, Svelto, Instances, Widgets, Plugin, Readify, Widgetize) {
  ...
  var Factory = {
    ...
    make: function make(Widget, config) {
      ...
      var instances = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : Instances;
    ...
    unmake: function unmake(Widget) {
      ...
      var instances = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Instances;
    ...
    unmakers: {
      ...
      instances: function instances(Widget, namespace, _instances2) {
        ...
        _.forEachRight(_instances2[Widget.config.Name], function (instance) {
...
(function ($, _, Svelto, Instances, Templates, Widgets, Factory, Pointer, Keyboard, Breakpoints, Breakpoint) {
  ...
  var Widget = function () {
    ...
    function Widget(options, element) {
      ...
      if (!(this.Name in Templates)) {
        ...
        for (var template in this.templates) {
          ...
          Templates[this.Name][template] = _.template(this.templates[template], _options);
        }
      }
    ...
    _createClass(Widget, [{
      ...
      key: '_getConfigInherited',
      value: function _getConfigInherited() {
      ...
      value: function unlock(namespace) {
        ...
        if (this._lockQueues[namespace]) {
          ...
          try {
            ...
            for (var _iterator11 = this._lockQueues[namespace][Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
      ...
      value: function __keydown(event) {
        ...
        for (var keystrokes in this.options.keystrokes) {
          ...
          try {
            for (var _iterator12 = keystrokes.split(',')[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
              var keystroke = _step12.value;
  ...
  var Chart = function (_Widgets$Widget4) {
    ...
    _createClass(Chart, [{
      ...
      value: function _variables() {
        ...
        try {
          for (var _iterator13 = properties[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
...
(function ($, _, Svelto, Widgets, Factory, Animations, Browser, Pointer, Mouse) {
  ...
  var config = {
    ...
    options: {
      ...
      threshold: {
        // Minimum moving treshold for triggering a drag. They can also be functions that return the threshold
      ...
      value: function _actionMove(deltaXY, suppressClasses) {
        ...
        if (!this.inited) {
          ...
          if (this.options.constrainer.$element) {
            ...
            var constrainerOffset = this.options.constrainer.$element[0] === window ? { top: $.$window.scrollTop(), left: $.$window.scrollLeft() } : this.options.constrainer.$element.offset(),
  ...
  var FormSync = function (_Widgets$Widget10) {
    ...
    _createClass(FormSync, [{
      ...
      value: function __sync(event, data) {
        ...
        try {
          for (var _iterator15 = $otherElements[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
            var otherElement = _step15.value;
    ...
    _createClass(Ripple, [{
      ...
      value: function __up() {
        ...
        this._defer(function () {
          ...
          try {
            for (var _iterator16 = this.circles[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
              var _step16$value = _slicedToArray(_step16.value, 2),
                  $circle = _step16$value[0],
                  timestamp = _step16$value[1];
    ...
    _createClass(TableHelper, [{
      ...
      value: function add(id) {
        ...
        if (datas.length) {
          ...
          try {
            for (var _iterator17 = chunks[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
    ...
    _createClass(Closer, [{
      ...
      value: function close(event) {
        ...
        this._targetInstance.whenUnlocked(function () {
          return _this35._targetInstance[_this35.options.methods.close](_this35.element, event);
        });
  ...
  var Opener = function (_Widgets$Closer5) {
    ...
    _createClass(Opener, [{
      ...
      value: function open(event) {
        ...
        this._targetInstance.whenUnlocked(function () {
          return _this41._targetInstance[_this41.options.methods.open](_this41.element, event);
        });
      ...
      value: function preload(callback) {
        ...
        $.ajax({
          ...
          success: function success() {
            _this55._isPreloaded = true;
            if (_this55.options.original.substitute) {
              _this55.$zoomable.attr('src', _this55.options.original.src);
            }
            if (callback) callback();
          },
          error: function error() {
            console.error('Zoomable: failed to preload "' + _this55.options.original.src + '"');
          },
          complete: function complete() {
            _this55._isPreloading = false;
          }
        });
      }
    }, {
    ...
    _createClass(Panel, [{
      ...
      value: function _variables() {
        ...
        this.options.direction = Directions.get().find(function (direction) {
          return _this61.$panel.hasClass(direction);
  ...
  var Tabs = function (_Widgets$Autofocusabl6) {
    ...
    _createClass(Tabs, [{
      ...
      value: function _variables() {
        ...
        this.options.direction = Directions.get().find(function (direction) {
          return _this66.$tabs.hasClass(direction);
        }) || this.options.direction;
...
(function ($, _, Svelto, EmojiDataRaw) {
  ...
  var EmojiData = {
    ...
    _parse: function _parse(data) {
      ...
      try {
        for (var _iterator18 = data.categories[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
          ...
          try {
            ...
            for (var _iterator19 = category.emojis[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
              _loop2();
            }
          } catch (err) {
...
(function ($, _, Svelto, Widgets, Factory, Fullscreen) {
  ...
  var Fullscreenable = function (_Widgets$Widget27) {
    _inherits(Fullscreenable, _Widgets$Widget27);
...
(function ($, _, Svelto, Widgets, Factory, Storage) {
  ...
  var Storable = function (_Widgets$Widget28) {
    _inherits(Storable, _Widgets$Widget28);
  ...
  var Select = function (_Widgets$Widget31) {
    ...
    _createClass(Select, [{
      ...
      value: function ___selectOptions() {
        ...
        try {
          for (var _iterator22 = this.$options[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
...
(function ($, _, Svelto, Widgets, Factory, Color, Keyboard) {
  ...
  var Colorpicker = function (_Widgets$Widget32) {
    _inherits(Colorpicker, _Widgets$Widget32);
        ...
        try {
          for (var _iterator23 = this.$elements[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
            ...
            if (validationsStr) {
              ...
              try {
                for (var _iterator24 = validationsArr[Symbol.iterator](), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
                  var validationStr = _step24.value;
    ...
    _createClass(FormAjax, [{
      ...
      value: function _autoclose() {
        ...
        var _loop3 = function _loop3(i, l) {
          ...
          var $closable = _this95.$form.closest(selectors[i]);

          if (!$closable.length) return 'continue';

          var method = _.isArray(methods) ? methods[i] : methods;

          if (_this95.options.spinnerOverlay) {

            _this95._on('spinneroverlay:close', function () {
      ...
      value: function __submit(event) {
        ...
        $.ajax({
          ...
          beforeSend: function beforeSend() {
            ...
            if (_this96.options.spinnerOverlay) {

              _this96.$form.spinnerOverlay('open');
            }

            _this96._trigger('beforesend');
          },
          ...
          error: function error(res) {
            ...
            $.toast(_.isError(resj) || !('message' in resj) ? _this96.options.messages.error : resj.msg);

            _this96._trigger('error');
          },
          ...
          success: function success(res) {
            ...
            if (!_.isError(resj)) {
              ...
              if (resj.refresh || resj.url === window.location.href || _.isString(resj.url) && _.trim(resj.url, '/') === _.trim(window.location.pathname, '/')) {
                ...
                $.toast(resj.message || _this96.options.messages.refreshing);
                ...
                $.toast(resj.message || _this96.options.messages.redirecting);

                location.assign(resj.url);
              } else {

                $.toast(resj.message || _this96.options.messages.success);
              }

              if (_this96.options.autoclose.enabled) _this96._autoclose();
            } else {

              $.toast(_this96.options.messages.success);
            }

            _this96._trigger('success');
          },
          ...
          complete: function complete() {
            ...
            if (_this96.options.spinnerOverlay) {
              ...
              _this96.$form.spinnerOverlay('close');
            }

            _this96._trigger('complete');
          }
        ...
        if (!this.options.rated && !this.doingAjax && this.options.url) {
          ...
          $.ajax({
            ...
            error: function error(res) {
              ...
              $.toast(_.isError(resj) || !('message' in resj) ? _this98.options.messages.error : resj.message);
            },
            ...
            success: function success(res) {
              ...
              if (!_.isError(resj)) {
                ...
                _.merge(_this98.options, resj);

                _this98.$rater.html(_this98._template('stars', _this98.options));

                _this98.options.rated = true;

                _this98._trigger('change');
              }
            },

            complete: function complete() {

              _this98.doingAjax = false;
            }
  ...
  var RemoteLoader = function (_Widgets$Remote2) {
    ...
    _createClass(RemoteLoader, [{
      ...
      value: function _init() {
        ...
        this._defer(function () {
          return !_this102.isRequesting() && _this102.disable();
    ...
    _createClass(RemoteWidget, [{
      ...
      value: function _widgetDestroy() {
        ...
        instance.whenUnlocked(function () {
          ...
          instance[_this108.options.methods.close]();

          _this108._delay(function () {
            ...
            this.$widget = false;
          }, instance.options.animations[_this108.options.methods.close]);
        });
      }
    ...
    _createClass(SelectableActions, [{
      ...
      value: function _getIds() {
        ...
        var $rows = this._targetInstance.get(),
          ...
          return _this116.options.selectors.id ? $(row).find(_this116.options.selectors.id).text() : $(row).data(_this116.options.datas.id);
        });
...
(function ($, _, Svelto, Widgetize, EmojiData, Emoji) {
  ...
  var Emojify = {
    ...
    parseEmoticon: function parseEmoticon(str, options) {
      var matches, _iteratorNormalCompletion25, _didIteratorError25, _iteratorError25, _iterator25, _step25, match, emoticon, index, _emoji, parsed;
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            ...
            case 2:
              ...
              _context14.prev = 6;
              _iterator25 = matches[Symbol.iterator]();
            ...
            case 8:
              ...
              match = _step25.value;
              emoticon = match.emoticon, index = match.index;
            ...
            case 27:
              ...
              _iteratorError25 = _context14.t0;
    ...
    parseEncoded: function parseEncoded(str, options) {
      var matches, _iteratorNormalCompletion26, _didIteratorError26, _iteratorError26, _iterator26, _step26, match, encoded, name, tone, _emoji2, parsed;
        ...
        while (1) {
          switch (_context15.prev = _context15.next) {
            ...
            case 2:
              ...
              _context15.prev = 6;
              _iterator26 = matches[Symbol.iterator]();
            ...
            case 27:
              ...
              _iteratorError26 = _context15.t0;
    ...
    _createClass(Emojipicker, [{
      ...
      value: function __lazyEmojify() {
        ...
        $container.emojify(this.options.make).then(function () {
          return $container.addClass(_this121.options.classes.emojified);
        });
      ...
      value: function _updateToneEmojis() {
        ...
        $tonables.get().forEach(function (emoji) {
          ...
          Emoji.make(id, tone, _this122.options.make).then(function (replacement) {
      ...
      value: function _updatePreview() {
        ...
        $enlarged.emojify(this.options.make).then(function () {
          ...
          _this123.$preview = $preview.replaceAll(_this123.$preview);
        });
      }
    }, {
      key: '_togglePreview',
      ...
      value: function __search() {
        ...
        $search.emojify(this.options.make).then(function () {
          ...
          _this124.$search = $search.replaceAll(_this124.$search);
        });
      }
    }, {
      key: '_toggleSearch',
      ...
      value: function _frequentRefresh() {
        ...
        $frequent.emojify(this.options.make).then(function () {
          ...
          _this125.$frequent = $frequent.replaceAll(_this125.$frequent);
        });
      }
    }, {
      key: '_frequentUpdate',
        ...
        if (this.isLocked()) {
          ...
          if (this._isEmpty()) {
            ...
            EmojiData.get().then(function (data) {
              ...
              _this127.$element = $.widget.new(Widgets.Emojipicker).$element.addClass(_this127.options.classes.popover);

              _this127.toggle(anchor);
            });
