    ...
    _createClass(_class, [{
      ...
      value: function on($root) {
        ...
        try {
          ...
          for (var _iterator = this.widgetizers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var widgetizer = _step.value;
      ...
      value: function open() {
        ...
        if (!this._isOpen) {
          ...
          this._frame(function () {
            ...
            $('.noty-queues.' + _this2.options.anchor.y + ' .noty-queue.' + _this2.options.anchor.x).append(_this2.$noty);

            _this2._frame(function () {

              _this2.$noty.addClass(_this2.options.classes.open);
            });
          });
        ...
        try {
          for (var _iterator = this.$elements[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (validationsStr) {
              ...
              try {
                for (var _iterator2 = validationsArr[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                  var validationStr = _step2.value;
        ...
        if (this.$form.formValidate('isValid')) {
          ...
          $.ajax({
            ...
            beforeSend: function beforeSend() {
              ...
              if (_this2.options.spinnerOverlay) {

                _this2.$form.spinnerOverlay('show');
              }

              _this2._trigger('beforesend');
            },
            ...
            complete: function complete() {
              ...
              if (_this2.options.spinnerOverlay) {
                ...
                _this2.$form.spinnerOverlay('hide');
              }

              _this2._trigger('complete');
            }
      ...
      value: function ___syncer() {
        ...
        try {
          var _loop = function _loop() {
            ...
            var $element = $(element),
                name = $element.attr(_this2.options.attributes.name),
                isCheckable = $element.is(_this2.options.selectors.checkable),
                isRadio = isCheckable && $element.is(_this2.options.selectors.radio),
                isTextfield = $element.is(_this2.options.selectors.textfield),
                events = isTextfield ? 'input change' : 'change',
                $currentForm = $element.parents(_this2.options.selectors.form),
                $otherForms = $forms.not($currentForm),
                $otherElements = $otherForms.find('[' + _this2.options.attributes.name + '="' + name + '"]');
            ...
            $element.on(events, function () {
              ...
              try {
                for (var _iterator2 = $otherElements[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                  var otherElement = _step2.value;
      ...
      value: function toggle(force) {
        ...
        if (force !== this._isOpen) {
          ...
          this._frame(function () {
            ...
            _this2.$overlay.toggleClass(_this2.options.classes.open, _this2._isOpen);

            _this2._trigger(_this2._isOpen ? 'open' : 'close');
          });
        }
      }
    }, {
        ...
        if (!this.alreadyRated && !this.doingAjax && this.options.url) {
          ...
          $.ajax({
            ...
            success: function success(res) {
              ...
              _.merge(_this2.options, res);

              _this2.$rater.html(_this2._tmpl('stars', _this2.options));

              _this2.alreadyRated = true;

              _this2._trigger('change', {
                value: _this2.options.value,
                amount: _this2.options.amount
              });s;
            },
...
(function ($, _, window, document, undefined) {
  ...
  $.fn.touching = function (options) {
    ...
    if (options.$comparer) {
      ...
      try {
        for (var _iterator = $searchable[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var searchable = _step.value;
    ...
    if (options.point) {
      ...
      if (options.binarySearch) {
        ...
        try {
          ...
          for (var _iterator2 = $searchable[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var searchable = _step2.value;
