...
!function(t,e,i,n,s){"use strict";t.Widget=function(){},t.Widget._childConstructors=[],t.Widget.prototype={namespace:!1,widgetName:"widget",widgetFullName:"widget",templates:{base:!1},options:{selectors:{},classes:{},animations:{},callbacks:{},disabled:!1},_create:function(i,n){if(!n&&!this.templates.base)throw"WidgetUninitializable";this.options=e.merge({},this.options,this._createOptions(),i),this.$element=t(n||this._tmpl("base",this.options)),this.element=this.$element[0],this.guid=t.guid++,this.options.disabled=this.options.disabled||this.$element.hasClass(this.widgetName+"-disabled"),t.data(this.element,this.widgetFullName,this),this._on(!0,"remove",function(t){t.target===this.element&&this.destroy(t)}),this._variables(),this._init(),this._events()},_createOptions:e.noop,_variables:e.noop,_init:e.noop,_events:e.noop,destroy:function(){this._destroy(),t.removeData(this.element,this.widgetFullName)},_destroy:e.noop,widget:function(){return this.$element},option:function(t,i){if(0===arguments.length)return e.cloneDeep(this.options);if(e.isString(t)){var n={},s=t.split(".");if(t=s.shift(),s.length){for(var o=n[t]=e.extend({},this.options[t]),r=0;r<s.length-1;r++)o[s[r]]=o[s[r]]||{},o=o[s[r]];if(t=s.pop(),1===arguments.length)return e.isUndefined(o[t])?null:o[t];o[t]=i}else{if(1===arguments.length)return e.isUndefined(this.options[t])?null:this.options[t];n[t]=i}}else e.isPlainObject(t)&&this._setOptions(t);return this},_setOptions:function(t){for(var e in t)this._setOption(e,t[e]);return this},_setOption:function(t,e){return this.options[t]=e,"disabled"===t&&this.$element.toggleClass(this.widgetName+"-disabled",!!e),this},enable:function(){return this._setOptions({disabled:!1})},disable:function(){return this._setOptions({disabled:!0})},_on:function(i,n,s,o,r){function l(){if(i||!h.options.disabled){var t=e.slice(arguments);return t.push(this),r.apply(h,t)}}var h=this;return e.isBoolean(i)||(r=o,o=s,s=n,n=i,i=!1),n instanceof t||(r=o,o=s,s=n,n=this.$element),o&&!r&&(r=o,o=!1),r=e.isString(r)?this[r]:r,l.guid=r.guid=r.guid||l.guid||t.guid++,o?n.on(s,o,l):n.on(s,l),this},_off:function(t,i,n){return n||(n=i,i=t,t=this.$element),n=e.isString(n)?this[n]:n,t.off(i,n),this},_trigger:function(t,i){i=i||{},t=t.split(" ");for(var n=0,s=t.length;s>n;n++)this.$element.trigger(this.widgetName+":"+t[n],i),e.isFunction(this.options.callbacks[t[n]])&&this.options.callbacks[t[n]].call(this.element,i);return this},_delay:function(t,e){var i=this;return setTimeout(function(){t.apply(i,arguments)},e||0)},_defer:function(t){return this._delay(t)},_debounce:function(t,i,n){return e.debounce(t,i,n)},_throttle:function(t,i,n){return e.throttle(t,i,n)},_tmpl:function(e,i){return t.tmpl(this.widgetFullName+"-"+e,i||{})},insertBefore:function(t){return this.$element.insertBefore(t),this},insertAfter:function(t){return this.$element.insertAfter(t),this},prependTo:function(t){return this.$element.prependTo(t),this},appendTo:function(t){return this.$element.appendTo(t),this}}}(jQuery,_,window,document);
...
!function(e,t,i,s,n){"use strict";e.factory("svelto.stepper",{options:{min:0,max:100,value:0,step:1,decimals:0,callbacks:{increase:t.noop,decrease:t.noop}},_variables:function(){this.$stepper=this.$element,this.$input=this.$stepper.find("input"),this.$decreaser=this.$stepper.find(".stepper-decreaser"),this.$increaser=this.$stepper.find(".stepper-increaser")},_events:function(){this._on(!0,this.$input,"input change",this._handler_input_change),this._on("mouseenter",this._handler_arrows_in),this._on("mouseleave",this._handler_arrows_out),this._on(this.$decreaser,"click",this.decrease),this._on(this.$increaser,"click",this.increase)},_round_value:function(e){return Number(Number(e).toFixed(this.options.decimals))},_handler_input_change:function(){this.set_value(this.$input.val())},_handler_arrows_in:function(e){this._on($document,"keydown",this._handler_arrows_keydown)},_handler_arrows_out:function(e){this._off($document,"keydown",this._handler_arrows_keydown)},_handler_arrows_keydown:function(t){t.keyCode===e.ui.keyCode.LEFT||t.keyCode===e.ui.keyCode.DOWN?this.decrease():(t.keyCode===e.ui.keyCode.RIGHT||t.keyCode===e.ui.keyCode.UP)&&this.increase()},set_value:function(e){if(e=this._round_value(e),e!==this.options.value||0===this.$input.val().length){var i=t.clamp(this.options.min,e,this.options.max);this.options.value=i,this.$input.val(i).trigger("change"),this.$decreaser.toggleClass("disabled",i===this.options.min),this.$increaser.toggleClass("disabled",i===this.options.max),this._trigger(i>this.options.value?"increase":"decrease")}},increase:function(){this.navigate(this.options.step)},decrease:function(){this.navigate(-this.options.step)},navigate:function(e){var t=this.options.value+e;this.set_value(t)}}),e(function(){e(".stepper").each(function(){var t=e(this),i=t.find("input"),s={min:Number(t.data("min")||0),max:Number(t.data("max")||100),value:Number(i.val()||0),step:Number(t.data("step")||1),decimals:Number(t.data("decimals")||0)};t.stepper(s)})})}(jQuery,_,window,document);
